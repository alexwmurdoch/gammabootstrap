        ...
        <div class="row">
            ...
            <div id="primary" class="col-md-12 col-lg-12">
                <main id="main" class="site-main portfolio" role="main">
                    ...
                    <?php
                        if (alphabootstrap_option('filter_switch') == '1') {
                            $terms = get_terms("portfolio_tags");
                            $count = count($terms);
                            $filter_btn_size = alphabootstrap_option('filter_size');
                            $filter_btn_color = alphabootstrap_option('filter_color');
                    ...
                    $pcount = alphabootstrap_option('portfolio_column', '3'); ?>
